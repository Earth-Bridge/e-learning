...
![InSAR principle illustrated with interference patterns. Two wave sources create characteristic fringe patterns where waves constructively or destructively interfere. Applying this principle from space, two SAR acquisitions from slightly different positions create interferometric fringes that encode topographic information. Maxima occur when path difference ΔR = nλ, corresponding to phase difference Δφ = n·2π. Adapted from: Iain H. Woodhouse, 2017](SART_figures/slide6_insar.png){#fig-insar width="70%"}
...
![From random phase to meaningful interferometric patterns. Left: Amplitude and phase of a single SAR image—the phase appears random. Center: Phase difference between two SAR images (wrapped interferogram) reveals systematic fringe patterns. Right: After unwrapping and further processing, a Digital Elevation Model (DEM) is derived. Source: Michael Eineder and Richard Bamler, EO-College (license: CC BY-SA 4.0).](SART_figures/slide8_insar_dem.png){#fig-phase-diff width="100%"}
...
Radar polarization describes the orientation and behavior of the electromagnetic wave transmitted and received by a radar system. Common polarizations include horizontal (H) and vertical (V), leading to modes such as HH, VV, HV, and VH, which indicate the polarization of the transmitted and received signals. Different targets interact with these polarizations in distinct ways depending on their shape, orientation, and surface properties. By comparing responses from multiple polarizations, radar systems can better distinguish surface features, vegetation, and man-made objects, and can improve target classification and physical interpretation of the observed scene (for more detailed discussion see the section on [Radar basics](RADAR_theory.qmd#sec-polarization)).
